...
description: "How I diagnosed a self-inflicted DDoS caused by Bcrypt on a hot path using pprof — reducing a 27-node AWS cluster to just two instances, with back-of-the-envelope savings estimated $42k/month in cloud costs."
pubDate: "2026-05-04"
updatedDate: "2026-05-19"
heroImage: "../../assets/article-images/how-we-saved-iot-service-200-to-20000-rps/this-is-fine-meme-self-inflicted-ddos-hero-image.webp"
...
#   Towards Data Science: ""
  Hackernoon: "https://hackernoon.com/the-hidden-bcrypt-bug-that-turned-an-iot-gateway-into-a-cpu-furnace"
#   Dev.to: ""
draft: false
author: "Piko Monde"
---
...
import imgFlamegraphA from '../../assets/article-images/how-we-saved-iot-service-200-to-20000-rps/pprof-flamegraph-rbac-json-unmarshal-go.webp';
import imgFlamegraphB from '../../assets/article-images/how-we-saved-iot-service-200-to-20000-rps/pprof-flamegraph-bcrypt-hotpath-cpu-saturation.webp';
import imgThisIsFine from '../../assets/article-images/how-we-saved-iot-service-200-to-20000-rps/this-is-fine-meme-self-inflicted-ddos.webp';
import imgArchDiagram from '../../assets/article-images/how-we-saved-iot-service-200-to-20000-rps/request-flow-before-after-bcrypt-cache-singleflight.svg';
...
<TLDRBox>
  A ~27-node AWS cluster estimated at $42k/month was bottlenecked at 200 RPS because every telemetry ping was running bcrypt.CompareHashAndPassword on the hot path — a self-inflicted DDoS. Caching the validated credential in Redis + wrapping the Bcrypt call in singleflight brought it to 20,000+ RPS on just 2 instances.
</TLDRBox>
